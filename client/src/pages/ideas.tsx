...
import type { GenerateIdeasResponse } from "@shared/idea-contract";
...
export default function Ideas() {
  ...
  const {
    ...
    isError,
    error,
  } = useQuery<GenerateIdeasResponse>({
    queryKey: ["generatedIdeas"],
    queryFn: async () => {
      const cached = queryClient.getQueryData<GenerateIdeasResponse>([
        "generatedIdeas",
      ]);

      if (!cached) {
        throw new Error(
          "No generated ideas found. Please complete the questionnaire first.",
        );
      }
  ...
  const ideas = generatedIdeas?.ideas ?? [];
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-background flex items-center justify-center px-6">
        <div className="glass-card rounded-2xl p-8 text-center border border-white/10 max-w-lg">
          <h2 className="text-2xl font-bold mb-2">
            Loading generated ideas...
          </h2>
          <p className="text-muted-foreground">
            We are preparing your latest recommendation set.
          </p>
        </div>
      </div>
    );
  ...
  if (isError || !selectedIdea) {
    const message =
      error instanceof Error
        ? error.message
        : "No generated ideas are currently available.";
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center px-6">
        <div className="glass-card rounded-2xl p-8 text-center border border-white/10 max-w-lg">
          ...
          />
          <h2 className="text-2xl font-bold mb-2">No generated ideas found</h2>
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground hidden md:block">
              Based on your profile: AI/ML, IoT, 6 Months, Research Focus
            </p>
          </div>
        </div>
            ...
            <div className="space-y-4">
                ...
                >
                  <div className="flex justify-between items-start mb-2">
                    <div className="flex flex-wrap gap-1.5 mb-2">
                      <Badge
                        variant="secondary"
                        className="text-[10px] px-1.5 py-0 h-5 bg-white/5"
                      >
                        {idea.impact}
                      </Badge>
                      <Badge
                        variant="secondary"
                        className={`text-[10px] px-1.5 py-0 h-5 border ${getDifficultyColor(idea.difficulty)}`}
                      >
                        {idea.difficulty}
                      </Badge>
                    </div>
                    ...
                    >
                      <Bookmark
                        className={`w-4 h-4 ${savedIdeas.includes(idea.id) ? "fill-primary text-primary" : ""}`}
                      />
                    </button>
                  </div>
              ...
              <div className="mt-8 p-6 text-center border border-dashed border-white/10 rounded-xl bg-white/[0.01]">
                ...
                <p className="text-xs text-muted-foreground mb-4">
                  Adjust your questionnaire answers to generate a new batch.
                </p>
                <Link href="/plan">
                  <Button
                    variant="outline"
                ...
                >
                  ...
                  <div className="grid grid-cols-3 gap-4 mb-10">
                    <div className="glass-card p-4 rounded-xl border border-white/5 flex flex-col items-center justify-center text-center">
                      <span className="text-3xl font-display font-bold text-blue-400 mb-1">
                    ...
                    <div className="glass-card p-4 rounded-xl border border-white/5 flex flex-col items-center justify-center text-center">
                      <span className="text-3xl font-display font-bold text-purple-400 mb-1">
                  ...
                  <Tabs defaultValue="overview" className="w-full">
                    ...
                    >
                      <section>
                        <h3 className="flex items-center text-lg font-bold mb-3 text-glow">
                          <Target className="w-5 h-5 mr-2 text-primary" /> The
                          Problem
                        </h3>
                      ...
                      <section>
                        ...
                        <p className="text-muted-foreground leading-relaxed p-4 bg-yellow-400/5 rounded-xl border border-yellow-400/10">
                    ...
                    >
                      ...
                      <section>
                        ...
                        <p className="text-muted-foreground p-4 bg-blue-500/5 rounded-xl border border-blue-500/10">
                          {selectedIdea.datasets}
                        </p>
                      </section>
                    </TabsContent>
                    ...
                    >
                      <section>
                        <h3 className="flex items-center text-lg font-bold mb-4 text-glow">
                          <ListChecks className="w-5 h-5 mr-2 text-emerald-400" />{" "}
                        ...
                        <ul className="space-y-3">
                          {selectedIdea.deliverables.map((item, i) => (
                            <li
                              key={i}
                              className="flex items-center p-3 bg-emerald-500/5 rounded-lg border border-emerald-500/10"
                            >
                      ...
                      <section>
                        ...
                        <p className="text-muted-foreground p-4 bg-purple-500/5 rounded-xl border border-purple-500/10">
                          {selectedIdea.extensions}
                        </p>
                      </section>
                    </TabsContent>
                  </Tabs>
              ...
              <div className="p-6 border-b border-white/10 bg-white/5 flex justify-between items-center shrink-0">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Generated for: {selectedIdea.title}
                  </p>
                </div>
                  ...
                  <div className="relative border-l-2 border-white/10 ml-4 pl-8 space-y-12">
                      ...
                      <div className="glass-card p-4 rounded-xl space-y-2">
                        <div className="flex items-start gap-2">
                          ...
                          <span className="text-sm">
                            Conduct literature review on {selectedIdea.tags[0]}{" "}
                            techniques.
                          </span>
                        </div>
                        <div className="flex items-start gap-2">
                          <CheckCircle2 className="w-4 h-4 text-muted-foreground mt-1" />
                          <span className="text-sm">
                            Acquire and clean {selectedIdea.datasets}.
                          </span>
                        </div>
                        <div className="flex items-start gap-2">
                          <CheckCircle2 className="w-4 h-4 text-muted-foreground mt-1" />
                          <span className="text-sm">
                            Set up Git repository, CI/CD, and development
                            environment.
                          </span>
                        </div>
                      </div>
                    ...
                    <div className="relative">
                      ...
                      <h3 className="text-lg font-bold text-blue-400 mb-2">
                        Phase 2: Core Prototype (Weeks 4-8)
                      </h3>
                      <div className="glass-card p-4 rounded-xl space-y-2">
                        <div className="flex items-start gap-2">
                          <CheckCircle2 className="w-4 h-4 text-muted-foreground mt-1" />
                          <span className="text-sm">
                            Develop baseline model/backend API.
                          </span>
                        </div>
                        <div className="flex items-start gap-2">
                          <CheckCircle2 className="w-4 h-4 text-muted-foreground mt-1" />
                          <span className="text-sm">
                            ...
                            {selectedIdea.architecture[0].split(":")[1]}
                          </span>
                        </div>
                        <div className="flex items-start gap-2">
                          <CheckCircle2 className="w-4 h-4 text-muted-foreground mt-1" />
                          <span className="text-sm">
                            Draft initial internal documentation.
                          </span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="relative">
                      ...
                      <div className="glass-card p-4 rounded-xl space-y-2">
                        <div className="flex items-start gap-2">
                          <CheckCircle2 className="w-4 h-4 text-muted-foreground mt-1" />
                          <span className="text-sm">
                            Build frontend interface and connect to backend.
                          </span>
                        </div>
                        <div className="flex items-start gap-2">
                          <CheckCircle2 className="w-4 h-4 text-muted-foreground mt-1" />
                    ...
                    <div className="relative">
                      ...
                      <h3 className="text-lg font-bold text-emerald-400 mb-2">
                        Phase 4: Evaluation & Demo (Weeks 13-15)
                      </h3>
                      <div className="glass-card p-4 rounded-xl space-y-2">
                        <div className="flex items-start gap-2">
                          <CheckCircle2 className="w-4 h-4 text-muted-foreground mt-1" />
                          <span className="text-sm">
                            Run performance benchmarks and gather metrics.
                          </span>
                        </div>
                        <div className="flex items-start gap-2">
                          <CheckCircle2 className="w-4 h-4 text-muted-foreground mt-1" />
                          <span className="text-sm">
                            Finalize project report/thesis document.
                          </span>
                        </div>
                        <div className="flex items-start gap-2">
                          <CheckCircle2 className="w-4 h-4 text-muted-foreground mt-1" />
